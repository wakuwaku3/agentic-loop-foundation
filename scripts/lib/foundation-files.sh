...
readonly SHARED_FILES=(
  AGENTS.md .codex/config.toml .claude/settings.json .claude/hooks/confirm-main-worktree-edit.sh .claude/hooks/require-gh-body-file.sh docs/policies/cost.md docs/policies/testing.md docs/policies/external-environment.md docs/policies/development-environment.md docs/policies/ai-tool-neutrality.md
  docs/policies/github-language.md docs/policies/validation-harness.md docs/policies/continuous-delivery.md
  docs/policies/documentation.md docs/policies/resource-scalability.md
  docs/decisions/0002-github-issue-queue.md docs/decisions/0003-supervisor-resilience-and-api-budget.md docs/decisions/0004-worker-resume-and-handoff.md docs/decisions/0005-status-observability.md docs/decisions/0006-worker-hang-timeout.md docs/decisions/0007-loop-metrics.md docs/decisions/0008-multi-host-claim.md docs/decisions/0009-foundation-upgrade.md docs/decisions/0010-authorized-issue-disposition.md docs/decisions/0011-installed-runtime-profile.md docs/decisions/0012-provider-pool-fallback.md docs/decisions/0013-agentic-loop-modules.md docs/decisions/0014-scope-structural-conflict.md docs/decisions/0015-numeric-priority-marker.md docs/decisions/0016-failure-park-not-close.md docs/decisions/0017-requirement-traceability.md docs/decisions/0018-repository-capability-manifest.md docs/decisions/0019-issue-level-execution-control.md docs/decisions/0020-change-risk-preflight.md docs/decisions/0021-affected-check-selection.md docs/decisions/0022-flaky-test-detection-and-quarantine.md docs/decisions/0023-documentation-readership-boundaries.md docs/decisions/0024-secret-scanning.md docs/decisions/0025-resource-scalability-budget.md docs/decisions/0026-postmortem-closed-loop.md docs/decisions/0030-lost-requirement-detection.md docs/decisions/0031-stage-stall-threshold-and-provider-progress-signal.md docs/decisions/0032-time-constant-invariants-and-calibration.md docs/operations/issue-queue.md docs/operations/codebase-diagnosis.md docs/operations/loop-metrics.md docs/operations/upgrade.md docs/operations/traceability.md docs/operations/capability-manifest.md docs/operations/preflight.md docs/operations/affected-checks.md docs/operations/flaky-tests.md docs/operations/secret-scanning.md docs/operations/workload-budget.md docs/operations/postmortem.md
  docs/policies/postmortem.md
  ...
  .agents/skills/postmortem/agents/openai.yaml
  ...
  bin/lib/agentic-loop/capability.sh bin/lib/agentic-loop/control.sh bin/lib/agentic-loop/preflight.sh
  bin/lib/agentic-loop/flaky.sh bin/lib/agentic-loop/workload.sh bin/lib/agentic-loop/postmortem.sh
  bin/lib/agentic-loop/smoke.sh
)
readonly INIT_FILES=(
  ...
  scripts/flaky.sh tests/flaky-registry.toml
)
