...
6. Re-read the Issue and verify it is open, has exactly one category, and is either queued or running. Report its URL, category, and state, then stop without implementing it in the interactive session.
